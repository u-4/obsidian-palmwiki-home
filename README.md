...
- Windows / Linuxは未確認
- iPhone / iPadではレスポンシブ表示の試験を開始済みですが、iOS / Androidはまだ正式対応外

iPhone / iPad実機でSquareカード、狭幅ヘッダー、検索欄などの表示・基本操作を試験しています。ただし、回転、Split View、再起動時の復元、バックグラウンド復帰、ソフトウェアキーボード、長時間利用時のメモリを含む互換性確認は完了していません。これらを確認するまで、公開版はデスクトップ対応として配布します。
