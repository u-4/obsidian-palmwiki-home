...
- リポジトリは2026-07-12にPublicへ変更しました。最新版は[0.3.0 Release](https://github.com/u-4/obsidian-palmwiki-home/releases/tag/0.3.0)で、0.2.1、0.2.0、0.1.0も履歴として公開済みです。
- Obsidianコミュニティプラグインへの申請はまだ行っていません。
- 本文検索は0.3.0として公開済みです。今回のItemViewからMarkdownへの互換性小修正は0.3.1 Release候補として準備しています。
- 0.3.1もObsidian Desktop 1.12.7以上を対象とし、モバイル対応は次の段階で検証します。
...
- 0.3.1のPull Request、CI、Release workflow、公開成果物を検証し、実際のURLとSHA-256を記録する。
