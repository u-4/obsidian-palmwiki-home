...
- リポジトリは2026-07-12にPublicへ変更しました。最新版は[0.2.1 Release](https://github.com/u-4/obsidian-palmwiki-home/releases/tag/0.2.1)で、0.2.0と0.1.0も履歴として公開済みです。
- Obsidianコミュニティプラグインへの申請はまだ行っていません。
- 本文検索は`codex/full-text-search`で実装とテストVault確認を終え、0.3.0 Release候補として公開準備中です。公開が完了するまでは0.2.1が安定版です。
- 0.3.0もObsidian Desktop 1.12.7以上を対象とし、モバイル対応は次の段階で検証します。
...
- 0.3.0のPull Request、CI、Release workflow、公開成果物を検証し、実際のURLとSHA-256を記録する。
