...
- リポジトリは2026-07-12にPublicへ変更し、[0.1.0 Release](https://github.com/u-4/obsidian-palmwiki-home/releases/tag/0.1.0)を公開済みです。
...
- 左上Homeボタン所有機能とCard同一タブ遷移を0.2.0としてリリースします。
...
- 左上Homeボタン、複数split、ポップアウト、Card同一タブ遷移をコピーVaultで手動確認する。
